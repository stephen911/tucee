                        ...
                        <div class="container-fluid page__container p-0">
                            ...
                            if ($user['paystatus'] == "paid") {
                                echo '<div class="card border-left-3 border-left-danger card-2by1">
                                    ...
                                    <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeQY58KqD_OftJgbOlxBbNXeKiTqx95T_lXIFwDaCNNMplmbg/viewform?embedded=true" width="640" height="1923" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>';
                                    } else {
                                echo '<div class="card border-left-3 border-left-danger card-2by1">
                                        <div class="card-body">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    Evaluation will be made available after Payment. Thank You!
                                                    <!-- <strong class="text-danger">$25.00</strong> <a href="#">#8331</a> -->
                                                </div>
                                                <div class="media-right">
                                                    ' . $yolk->handler() . '
