...
const registeredInput = document.getElementById("regnumber");
const lincesedInput = document.getElementById("lincesed");
...
image.onload = function () {
  ...
  // drawImage2()
  drawImage();
  drawText(nameInput.value.toUpperCase(), 3650, 860, 80, "monotype arial");
