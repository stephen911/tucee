...
const downloadBtn = document.getElementById('download-btn')
        ...
        window.devicePixelRatio=10;      //Clear Text 
        ...
        canvas.height = Math.floor(650 * scale); 
...
image.src = 'assets/images/training.png'
image.onload = function () {
	...
	// drawImage2()
	drawImage()
	drawText(nameInput.value.toUpperCase(), 3650, 860, 70,'monotype arial');
// drawText(districtInput.value.toUpperCase(), 1250, 2050, 40,'monotype arial');
drawText(dateInput.value.toUpperCase(), 1945, 2070, 60,'monotype arial');
// drawText(dateInput.value.toUpperCase(), 1915, 3750, 60,'monotype arial');
...
downloadBtn.addEventListener('click', function () {
	...
	downloadBtn.download = 'Training-History' 
})