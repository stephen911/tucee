...
image.src = 'assets/images/tickets.png'
image.onload = function () {
	...
	// drawImage2()
	drawImage()
	drawText(nameInput.value.toUpperCase(), 810, 854, 80,'Verdana');
drawText(districtInput.value.toUpperCase(), 450, 1165, 40,'monotype arial');
drawText(dateInput.value.toUpperCase(), 1180, 1165, 40,'monotype arial');
...
downloadBtn.addEventListener('click', function () {
	...
	downloadBtn.download = 'TUCEE-NTC-Ticket' 
})