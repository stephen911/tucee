    ...
    <div class="mdk-header-layout__content">
        ...
        <div data-push data-responsive-width="992px" class="mdk-drawer-layout js-mdk-drawer-layout">
                                ...
                                echo '<div class="card border-left-3 border-left-danger card-2by1">
                                        <div class="card-body">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-right">
                                                    <a href="ticket.php" 
                                                       class="btn btn-success float-right">View Ticket</a>
                                                </div>
            ...
            <input id="name" type='text'>
                            ...
                            <input id="regnumber" type='hidden' value="<?php echo $user['regnumber']; ?>">
                            <input id="lincesed" type='hidden' value="<?php echo $user['lincesed']; ?>">
